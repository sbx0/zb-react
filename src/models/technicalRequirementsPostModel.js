...
import {postTechnicalAchievements} from '@/services/technicalRequirementsPostService';
import {
  getAddressFather,
  getAddressSons,
...
const TechnicalRequirementsPostModel = {
  namespace: 'technicalRequirementsPostModel',
  state: {
...
export default TechnicalRequirementsPostModel;
