...
export default function PostAchievements({setLoading, notice}) {
    ...
    const [cooperationMethod, setCooperationMethod] = useState(0);
    const [classificationOne, setClassificationOne] = useState(0);
    const [classificationTwo, setClassificationTwo] = useState(0);
